...
async def post_videos_commit(commit_request: CommitRequest) -> dict:
    ...
    """
    video_dirs = {
        video_id: _video_dir(video_id) for video_id in commit_request.assignments
    }
    ...
    result = commit_reviewed_clips(WORK_DIR / "youtube", None, _dataset_dir_for)
    committed = {
