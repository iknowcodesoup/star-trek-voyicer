...
import fs_paths
from models import YOUTUBE_STAGES_NEEDING_URL, Job, JobRequest
from services.webhook_notifier import WebhookNotifier

APP_DIR = fs_paths.APP_DIR
...
def _build_command(request: JobRequest) -> list[str]:
    ...
    if request.character:
        fs_paths._check_name(request.character, "character")
...
class JobRunner:
    ...
    def log_path(self, job_id: str) -> Path:
        return fs_paths.WORK_DIR / "_logs" / f"{job_id}.log"
