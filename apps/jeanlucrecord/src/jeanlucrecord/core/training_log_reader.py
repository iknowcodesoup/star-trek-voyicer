...
def parse_checkpoint_name(name: str) -> tuple[int | None, int | None]:
...
def parse_training_log(log_path: Path) -> tuple[int | None, float | None]:
    ...
    tail = read_from(log_path, tail_start).decode("utf-8", errors="replace")
